...
- [ ] Type `@` → Mention popup appears
- [ ] Type `@slack` → Popup filters to Slack tools
- [ ] Click mention → Token inserted in editor
...
**Solution**:
- Type `@` character
- Check `utils/mockTools.js` exists
- Verify `styles/popup.css` is imported
